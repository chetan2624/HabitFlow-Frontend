  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6 md:p-12 lg:p-24 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        {/* Left Side: Clerk Component Transparent Styled */}
        <div className="lg:w-1/2 flex justify-center lg:justify-start w-full">
           {/* We redirect to /onboarding after signup so the user can choose their custom illustration */}
           <SignUp 
        ...
        <div className="text-white lg:w-1/2 flex flex-col gap-6 lg:text-right items-start lg:items-end">
           ...
           <p className="text-lg md:text-xl text-white/90 drop-shadow-md max-w-lg font-light leading-relaxed">
             Find clarity in your routines. Sign up today and step into a more intentional version of yourself.
           </p>
        </div>
