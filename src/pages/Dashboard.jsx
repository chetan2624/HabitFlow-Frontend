...
const Dashboard = () => {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen bg-editorial-50 pb-24 md:pb-8">
      <header className="mb-8 md:mb-10">
        <p className="text-xs md:text-sm font-bold tracking-widest text-editorial-500 uppercase mb-2">
          {new Date().toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}
        </p>
        <h1 className="text-3xl md:text-4xl font-serif text-editorial-900 mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 md:mb-10">
        ...
        {/* Large Hero Card */}
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 md:p-10 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-editorial-200 flex flex-col sm:flex-row justify-between items-center relative overflow-hidden min-h-[300px] md:min-h-[340px] gap-6">
          <div className="z-10 relative sm:max-w-[60%] flex flex-col justify-between h-full">
            <div>
              ...
              <h2 className="text-2xl md:text-4xl font-serif text-editorial-900 mb-3 md:mb-4 leading-tight">
                You've nurtured {stats.todaysScore} of {stats.totalHabits || 0} rituals today.
              </h2>
            </div>
            <p className="text-editorial-500 text-sm md:text-lg leading-relaxed max-w-sm md:max-w-full">
              Keep it gentle. Tap a habit below to mark it done — no pressure to be perfect.
            </p>
          </div>
          
          <div className="w-full sm:w-[35%] h-48 sm:h-full relative flex items-center justify-center z-0">
            <img src="/new-assests/Coach-cuate.svg" alt="Coach Illustration" className="max-h-full object-contain drop-shadow-xl" />
          </div>
        </div>

        {/* Right Column Features */}
        <div className="flex flex-col gap-6 sm:flex-row lg:flex-col lg:h-[340px]">
          <Link to="/tracker" className="bg-primary-500 hover:bg-primary-600 text-editorial-900 font-bold text-lg py-5 px-6 rounded-2xl w-full flex items-center justify-center gap-3 shadow-sm transition-all hover:-translate-y-1 shrink-0">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-editorial-200 flex-1 flex flex-col justify-center items-center text-center">
            <img src="/new-assests/undraw_yoga_i399.svg" alt="Yoga Intention" className="h-24 md:h-28 mb-4 md:mb-6 object-contain" />
            <h3 className="font-serif text-lg md:text-xl text-editorial-900 mb-2 font-semibold">Daily intention</h3>
            <p className="text-editorial-500 text-xs md:text-sm italic leading-relaxed">"Slow is smooth, smooth is steady."</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 md:mb-12">
        {/* Streak */}
        <div className="bg-white rounded-3xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-editorial-200 flex flex-col justify-between min-h-[140px]">
           ...
           <div>
             <h3 className="text-2xl md:text-3xl font-serif text-editorial-900 mb-1">{streak} days</h3>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-editorial-200 flex flex-col justify-between min-h-[140px]">
           ...
           <div>
             <h3 className="text-2xl md:text-3xl font-serif text-editorial-900 mb-1">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-editorial-200 flex flex-col justify-between min-h-[140px]">
           ...
           <div>
             <h3 className="text-2xl md:text-3xl font-serif text-editorial-900 mb-1">{stats.todaysScore}/{stats.totalHabits}</h3>
      ...
      <div>
        <h2 className="text-xl md:text-2xl font-serif text-editorial-900 mb-6">Today's habits</h2>
          ...
          {habits.length > 0 ? habits.map((habit) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 px-4 py-2.5 md:px-5 md:py-3 rounded-full font-medium transition-all text-sm md:text-base ${
                  isDone 
